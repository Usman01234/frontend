...
import type { MultichainProviderConfig, MultichainProviderConfigResult } from 'types/client/multichainProviderConfig';
...
const config: Feature<{ providers: Array<MultichainProviderConfigResult> }> = (() => {
  if (value) {
